...
class Selection:
    """
    ДОБАВЛЕНИЕ
    добавить метод, который обновляет матожидание, дисперсию и т.д.
    считывание с файла EXEL таблицы распределения случайной величины

    ОТЛАДКА
    как изменить все или часть элементов выборки
    как создать тесты
    """
